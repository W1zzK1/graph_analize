...
//    public void AchangeWeights(Graph<String, DefaultWeightedEdge> graph, String startVertex, Set<String> visited) {
...
//    }
    ...
    public void changeWeights(Graph<String, DefaultWeightedEdge> graph,
                              String startVertex,
                              String endVertex,
                              float newWeight) {
